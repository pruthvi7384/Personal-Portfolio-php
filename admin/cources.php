<?php
    ...
    if(isset($_GET['type']) && $_GET['type']!='' && isset($_GET['id']) && $_GET['id']>0){
        ...
        if($type=='deactive'){
            mysqli_query($con,"UPDATE cources SET status='0' WHERE id='$id'");
        }else{
            mysqli_query($con,"UPDATE cources SET status='1' WHERE id='$id'");
        }

        if($type=='delete'){
            mysqli_query($con,"DELETE FROM cources WHERE id='$id'");
        }
    }
    $sql = mysqli_query($con,"SELECT * FROM cources");
?>
...
<div class="d-flex justify-content-end edit">
   <span class="text-light me-4"></span> <a href="add-cources.php"><i class="fa fa-pencil" aria-hidden="true"></i></a>
</div>
    ...
    <div class="table-responsive mt-3">
        <table class="table table-dark table-striped">
            <thead>
                ...
                <th scope="col">Platform Details</th>
                <th scope="col">Description</th>
                <th scope="col">Your Performance 100 out of</th>
            ...
            ?>
                ...
                <td><?php echo $row['platforn_detailes']; ?></td>
                ...
                ?>
                    <a href="add-cources.php?id=<?php echo $row['id'] ?>"><button class="btn btn-success mt-1"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>&nbsp;
